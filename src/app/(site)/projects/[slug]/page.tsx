            ...
            <div className="flex flex-col gap-12 md:gap-24 py-20 xl:py-40">
              <div className="flex flex-col gap-10">
                <div>
                  <Link
                    href="/projects"
                    className="group flex gap-3 items-center w-fit bg-primary hover:bg-secondary rounded-full transition-all duration-500 ease-in-out"
                  >
                    <Image
                    ...
                    />
                    <span className="pr-4 text-lg font-bold text-white group-hover:text-white group-hover:-translate-x-10 transform transition-transform duration-500 ease-in-out">
                      Back
                    </span>
                  </Link>
                </div>
