            ...
            <div className="flex flex-col md:flex-row relative gap-10 2xl:gap-56">
              ...
              <div className="w-full flex flex-col gap-16">
                ...
                <div>
                  <Link
                    href="/projects"
                    className="group flex gap-4 items-center w-fit bg-primary border border-primary hover:border hover:bg-secondary rounded-full transition-all duration-200 ease-in-out"
                  >
                    <span className="pl-6 text-lg font-bold text-white group-hover:text-white group-hover:translate-x-12 transform transition-transform duration-200 ease-in-out">
                      See our Work
                    </span>
                    <svg
